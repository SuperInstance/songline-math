...
import { buildGraph, buildSongFromPath, extractSubSong, songCost, reverseSong } from "./song.js";
import { singPath, reachableNodes, pathExists, navigability } from "./navigation.js";
import { findCorroborees, clusterBySongs, songIntersection, findHubs } from "./corroboree.js";
import { distanceMatrix, bettiNumbers, persistentCycles, persistenceBarcode } from "./dreamtime.js";
import { createTradition, evolveGeneration, fittestSong, } from "./tradition.js";
/**
...
export class SonglineGraph {
     ...
     */
    addWaypoint(id, coordinates, metadata) {
     ...
     * @param metadata - Optional metadata
     */
    addVerse(from, to, weight, metadata) {
     ...
     */
    songIntersection(songIdA, songIdB) {
     ...
     */
    evolve(id, generations = 10, config) {
